...
static const char *FileLoadOperationClassPathName = "org/ستاره گرام/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/ستاره گرام/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/ستاره گرام/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/ستاره گرام/tgnet/RequestDelegateInternal;Lorg/ستاره گرام/tgnet/QuickAckDelegate;Lorg/ستاره گرام/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/ستاره گرام/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ستاره گرام/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ستاره گرام/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ستاره گرام/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/ستاره گرام/tgnet/ConnectionsManager"));
