...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "org.ستاره گرام.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "org.ستاره گرام.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "org.ستاره گرام.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "org.ستاره گرام.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "org.ستاره گرام.android.musicplayer.next";
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mediaSession = new MediaSession(this, "ستاره گرامAudioPlayer");
