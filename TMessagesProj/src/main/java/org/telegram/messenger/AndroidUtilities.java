...
import org.ستاره گرام.ui.Components.ForegroundDetector;
...
public class AndroidUtilities {
    ...
    private static File getAlbumDir() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            storageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "ستاره گرام");
                ...
                if (scheme != null) {
                    if ((scheme.equals("http") || scheme.equals("https"))) {
                        ...
                        if (url.startsWith("tg:socks") || url.startsWith("tg://socks")) {
                            url = url.replace("tg:proxy", "tg://ستاره گرام.org").replace("tg://proxy", "tg://ستاره گرام.org");
                            data = Uri.parse(url);
                            address = data.getQueryParameter("server");
                            port = data.getQueryParameter("port");
                            user = data.getQueryParameter("user");
