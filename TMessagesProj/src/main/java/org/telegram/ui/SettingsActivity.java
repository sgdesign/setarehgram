...
import org.ستاره گرام.tgnet.SerializedData;
...
import org.ستاره گرام.ui.Cells.TextInfoCell;
import org.ستاره گرام.ui.Cells.EmptyCell;
import org.ستاره گرام.ui.Cells.HeaderCell;
import org.ستاره گرام.ui.Cells.ShadowSectionCell;
import org.ستاره گرام.ui.Cells.TextCheckCell;
import org.ستاره گرام.ui.Cells.TextDetailSettingsCell;
import org.ستاره گرام.ui.Cells.TextSettingsCell;
...
import org.ستاره گرام.ui.Components.AvatarDrawable;
import org.ستاره گرام.ui.Components.AvatarUpdater;
...
import org.ستاره گرام.ui.Components.NumberPicker;
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                if (position == textSizeRow) {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showDialog(builder.create());
                } else if (position == ستاره گرامFaqRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("ستاره گرامFaqUrl", R.string.ستاره گرامFaqUrl));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.getString("ستاره گرامFAQ", R.string.ستاره گرامFAQ), true);
                    } else if (position == contactsReimportRow) {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == textSizeRow || position == enableAnimationsRow || position == notificationRow || position == backgroundRow || position == numberRow ||
                    ...
                    position == switchBackendButtonRow || position == ستاره گرامFaqRow || position == contactsSortRow || position == contactsReimportRow || position == saveToGalleryRow ||
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(LocaleController.formatString("ستاره گرامVersion", R.string.ستاره گرامVersion, String.format(Locale.US, "v%s (%d) %s", pInfo.versionName, code, abi)));
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                    break;
