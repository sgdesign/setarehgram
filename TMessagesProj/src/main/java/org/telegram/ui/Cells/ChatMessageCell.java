...
import org.ستاره گرام.ui.Components.RoundVideoPlayingDrawable;
import org.ستاره گرام.ui.Components.SeekBar;
import org.ستاره گرام.ui.Components.SeekBarWaveform;
import org.ستاره گرام.ui.Components.StaticLayoutEx;
...
import org.ستاره گرام.ui.PhotoViewer;
import org.ستاره گرام.ui.SecretMediaViewer;
    ...
    public void setMessageObject(MessageObject messageObject, MessageObject.GroupedMessages groupedMessages, boolean bottomNear, boolean topNear) {
        ...
        if (messageChanged || dataChanged || groupChanged || isPhotoDataChanged(messageObject) || pinnedBottom != bottomNear || pinnedTop != topNear) {
            ...
            if (messageObject.type == 0) {
                ...
                if (!drawInstantView) {
                    if ("ستاره گرام_channel".equals(webpageType)) {
                        drawInstantView = true;
                        drawInstantViewType = 1;
                    } else if ("ستاره گرام_megagroup".equals(webpageType)) {
                        drawInstantView = true;
