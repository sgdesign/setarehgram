...
import org.zanbilapp.messenger.LocationController;
...
import org.zanbilapp.messenger.NativeCrashManager;
...
import org.zanbilapp.messenger.camera.CameraController;
        ...
        sideMenu.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(final View view, int position) {
                ...
                if (position == 0) {
                    ...
                    Browser.openUrl(LaunchActivity.this, LocaleController.getString("ستاره گرامFaqUrl", R.string.ستاره گرامFaqUrl));
                    drawerLayoutContainer.closeDrawer(false);
                } else if (id == 10) {
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                        ...
                        if (data != null) {
                            ...
                            if (scheme != null) {
                                if ((scheme.equals("http") || scheme.equals("https"))) {
                                    ...
                                    if (host.equals("ستاره گرام.me") || host.equals("t.me") || host.equals("ستاره گرام.dog") || host.equals("telesco.pe")) {
                                    ...
                                    if (url.startsWith("tg:resolve") || url.startsWith("tg://resolve")) {
                                        url = url.replace("tg:resolve", "tg://ستاره گرام.org").replace("tg://resolve", "tg://ستاره گرام.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:join", "tg://ستاره گرام.org").replace("tg://join", "tg://ستاره گرام.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://ستاره گرام.org").replace("tg://addstickers", "tg://ستاره گرام.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://ستاره گرام.org").replace("tg://msg", "tg://ستاره گرام.org").replace("tg://share", "tg://ستاره گرام.org").replace("tg:share", "tg://ستاره گرام.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                    ...
                    } else if (intent.getAction().equals("org.zanbilapp.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
