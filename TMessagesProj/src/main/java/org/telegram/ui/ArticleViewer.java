...
import org.ستاره گرام.ui.ActionBar.ActionBarPopupWindow;
...
import org.ستاره گرام.ui.Components.ContextProgressView;
import org.ستاره گرام.ui.Components.LayoutHelper;
import org.ستاره گرام.ui.Components.LinkPath;
import org.ستاره گرام.ui.Components.RadialProgress;
import org.ستاره گرام.ui.Components.RecyclerListView;
import org.ستاره گرام.ui.Components.Scroller;
import org.ستاره گرام.ui.Components.SeekBar;
import org.ستاره گرام.ui.Components.ShareAlert;
import org.ستاره گرام.ui.Components.TextPaintSpan;
import org.ستاره گرام.ui.Components.TextPaintUrlSpan;
import org.ستاره گرام.ui.Components.TypefaceSpan;
import org.ستاره گرام.ui.Components.VideoPlayer;
import org.ستاره گرام.ui.Components.WebPlayerView;
            ...
            if (previousBlock != currentBlock) {
                ...
                try {
                    if (currentBlock.html != null) {
                        webView.loadDataWithBaseURL("https://ستاره گرام.org/embed", currentBlock.html, "text/html", "UTF-8", null);
                        videoView.setVisibility(INVISIBLE);
                        videoView.loadVideo(null, null, null, false);
                        webView.setVisibility(VISIBLE);
                    } else {
