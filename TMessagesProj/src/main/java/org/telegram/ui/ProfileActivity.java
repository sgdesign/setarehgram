...
import org.ستاره گرام.ui.Cells.AboutLinkCell;
...
import org.ستاره گرام.ui.Cells.TextCell;
import org.ستاره گرام.ui.Cells.TextDetailCell;
import org.ستاره گرام.ui.Cells.TextInfoPrivacyCell;
...
import org.ستاره گرام.ui.Components.IdenticonDrawable;
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow || position == channelNameRow) {
            ...
            if (userFull != null && userFull.phone_calls_available) {
                items.add(LocaleController.getString("CallViaستاره گرام", R.string.CallViaستاره گرام));
                actions.add(2);
            }
